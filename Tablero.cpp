...
void Tablero::ferJugada(SDL_Surface* pantalla, int x, int y, int valor)
{
    if(x > 0 && x <= 220 && y > 0 && y <= 220)
    {
        posiciones[0][0] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 4, 4);
        else CSurface::OnDraw(pantalla, O, 4, 4);
    }
    else if (x > 220 && x <= 440 && y > 0 && y <= 220)
    {
        posiciones[1][0] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 224, 4);
        else CSurface::OnDraw(pantalla, O, 224, 4);
    }
    else if (x > 440 && x <= 660 && y > 0 && y <= 220)
    {
        posiciones[2][0] = valor;
        if(valor == 1)  CSurface::OnDraw(pantalla, X, 444, 4);
        else CSurface::OnDraw(pantalla, O, 444, 4);
    }
    else if (x > 0 && x <= 220 && y > 220 && y <= 440)
    {
        posiciones[0][1] = valor;
        if(valor == 1)  CSurface::OnDraw(pantalla, X, 4, 224);
        else CSurface::OnDraw(pantalla, O, 4, 224);
    }
    else if (x > 220 && x <= 440 && y > 220 && y <= 440)
    {
        posiciones[1][1] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 224, 224);
        else CSurface::OnDraw(pantalla, O, 224, 224);
    }
    else if (x > 440 && x <= 660 && y > 220 && y <= 440)
    {
        posiciones[2][1] = valor;
        if(valor == 1)  CSurface::OnDraw(pantalla, X, 444, 224);
        else CSurface::OnDraw(pantalla, O, 444, 224);
    }
    else if (x > 0 && x <= 220 && y > 440 && y <= 660)
    {
        posiciones[0][2] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 4, 444);
        else CSurface::OnDraw(pantalla, O, 4, 444);
    }
    else if (x > 220 && x <= 440 && y > 440 && y <= 660)
    {
        posiciones[1][2] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 224, 444);
        else CSurface::OnDraw(pantalla, O, 224, 444);
    }
    else if (x > 440 && x <= 660 && y > 440 && y <= 660)
    {
        posiciones[2][2] = valor;
        if(valor == 1) CSurface::OnDraw(pantalla, X, 444, 444);
        else CSurface::OnDraw(pantalla, O, 444, 444);
    }
    turno++;
}
...
bool Tablero::llocLliure(int x, int y)
{
    return(posiciones[x][y] == 0);
}

void Tablero::posarFitxa(int x, int y, int valor)
{
    posiciones[x][y] = valor;
}

void Tablero::treureFitxa(int x, int y, int valor)
{
    if(posiciones[x][y] == valor)
    {
        posiciones[x][y] = 0;
    }
}
